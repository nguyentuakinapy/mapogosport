                ...
                <div className="mt-5">
                    <nav className="container m-auto">
                        <ul>
                            ...
                            <li><a className={`link ${isActive == 8 ? 'active' : ''}`} href="/admin/statistics" onClick={() => setIsActive(8)}><i className="bi bi-bar-chart me-2"></i>THỐNG KÊ</a></li>
                            <li><a className={`link ${isActive == 9 ? 'active' : ''}`} href="/admin/categories" onClick={() => setIsActive(9)}><i className="bi bi-box-seam me-2"></i>QUẢN LÝ LOẠI</a></li>
